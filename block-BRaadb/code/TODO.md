...
- Taking the help form of Higher Order Component refactor the app to have a withSearch that will add the function of search to nay page
- Create a withSearch named `withSearch` using which we can add the search function to all three pages
